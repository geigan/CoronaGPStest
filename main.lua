...
local locationHandler = function( event )
	...
	if event.errorCode then
		...
		local latitudeText = string.format( '%.6f', event.latitude )
		currentLatitude = latitudeText
		latitude.text = latitudeText
		
		local longitudeText = string.format( '%.6f', event.longitude )
		currentLongitude = longitudeText
		longitude.text = longitudeText
		
		local altitudeText = string.format( '%.6f', event.altitude )
